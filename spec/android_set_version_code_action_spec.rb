...
describe Fastlane::Actions::AndroidSetVersionCodeAction do
  describe "Set Version Code" do
    ...
    it "should increment Version Code of custom key and return its new value" do
      result = Fastlane::FastFile.new.parse('lane :test do
        android_set_version_code version_code_key: "baseVersionCode"
      end').runner.execute(:test)
      expect(Fastlane::Actions.lane_context[Fastlane::Actions::SharedValues::ANDROID_NEW_VERSION_CODE]).to eq(2)
    end
